...
// Ask beacons to light-sleep between transmits.  Nothing ever sent this
// before, so s_sleep_between stayed false and no beacon has ever slept.
...
// transition.
#define BEACON_CMD_REPEATS      5
#define BEACON_CMD_REPEAT_MS    25
